      ...
      <footer class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 border-t border-gray-200 dark:border-gray-700 mt-16 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
          ...
          <p class="text-center text-gray-600 dark:text-gray-400">
            CC0 2025-{{ currentYear }} Nouns: The Card Game. Developed by <a href="https://farcaster.xyz/tempetechie.eth" target="_blank" rel="noopener noreferrer" class="hover:underline font-semibold font-chewy">Tempe Techie</a>
          </p>
